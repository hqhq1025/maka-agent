...
export type SettingsPreferencesCopy = {
  ...
  general: {
    ...
    computerUse: string;
    computerUseHelp: string;
    enableComputerUse: string;
    computerUseFailed: string;
...
const SETTINGS_PREFERENCES_COPY_BY_LOCALE = {
  zh: {
    ...
    general: {
      computerUse: '电脑操作', computerUseHelp: '允许 Maka 观察你的屏幕并操作其它应用。还需要在系统设置里授予辅助功能和屏幕录制权限。', enableComputerUse: '启用电脑操作', computerUseFailed: '电脑操作开关切换失败', incognito: '隐身模式', incognitoHelp: '开启后暂停本地记忆读写、联网搜索和计划提醒触发。', enableIncognito: '启用隐身模式', incognitoFailed: '隐身模式切换失败', notifications: '完成时发送系统通知', notificationsHelp: '窗口不在前台时，在回答完成或出错后发送桌面通知。', notificationsFailed: '通知设置切换失败', updateFailed: '设置未生效，请稍后重试。',
